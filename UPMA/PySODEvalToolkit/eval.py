...
def get_args():
    ...
    #    --curves-npy output/rgbd_curves.npy \
    #    --record-txt output/rgbd_results.txt
    parser.add_argument("--metric-npy", type=str,default='output/rgbd_metrics.npy', help="Npy file for saving metric results.")
    parser.add_argument("--curves-npy", type=str,default='output/rgbd_curves.npy', help="Npy file for saving curve results.")
    parser.add_argument("--record-txt", type=str,default='output/rgbd_results.txt', help="Txt file for saving metric results.")
    parser.add_argument("--to-overwrite", action="store_true", help="To overwrite the txt file.")
    parser.add_argument("--record-xlsx", type=str,default='output/rgbd_results.xlsx', help="Xlsx file for saving metric results.")
    parser.add_argument(
        "--include-methods",
        type=str,
        default=['CAMO','COD10K','HC4K','CHAMELEON'],
        #default=['WSA1'],
        nargs="+",
...
def main():
    ...
    # A dictionary containing all dataset information
    datasets_info = get_datasets_info(
        datastes_info_json=args.dataset_json,
        include_datasets=args.include_datasets,
        exclude_datasets=args.exclude_datasets,
    )
    # A dictionary containing information about all model results to be compared
    ...
    # Ensure that multi-process can also be used normally on Windows
